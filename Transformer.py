...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        (
            ...
            x.size()
        )   # batch size (bactch_size), sequence length (block_size), embedding dimensionality (dim_embedding)
...
class EncoderDecoderAttention(nn.Module):
    ...
    def forward(self, x, e):
        ...
        (
            ...
            e.size()
        )  # batch size (batch_size), sequence length (block_size), embedding dimensionality (dim_embedding)

        # calculate key and values vectors from the output of the encoder
        ...
        # calculate the query vectors from the output of the previous decoder layer
